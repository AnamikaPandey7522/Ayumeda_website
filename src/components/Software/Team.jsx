...
import advisors from '@data/Software/advisors.json'

const Team = () => {
  return (
    <section className="team section-padding style-1 team-blue2" data-scroll-index="4">
